...
wget https://raw.githubusercontent.com/remo7777/evtpro773/master/evtpro773.flf &> /dev/null;
sleep 3
...
clear;
echo -e "\033[31m$(figlet -f evtpro773 "T- Header")\e[0m"
echo -e "\e[1;32m
+----------------------------------*/
evtpro773 : (\e[33m14.4.2021\e[32m)
